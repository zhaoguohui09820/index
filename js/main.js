...
class App {
    constructor() {
        console.log(" %c Theme Cuteen Version " + CuteenConfig.theme_version + " %c blog.zwying.com", "color:#E6EDF3;background:linear-gradient(90deg,#448bff,#44e9ff);padding:5px 0;", "color:#000;background:linear-gradient(90deg,#44e9ff,#E6EDF3fff);padding:5px 10px 5px 0px;");
        ...
        fm.onsubmit = function (e) {
            ...
            fetch(action, {
                ...
                let parser = new DOMParser(),
                    dom = parser.parseFromString(res, "text/html"); //字符串转DOM
